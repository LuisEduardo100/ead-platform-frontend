...
const Control = ({
  ...
  return (
    <ControlContainer
      className={`${styles.control_Container} ${!showControls ? styles.hidden : ""}`}
      ref={controlRef}
    >
      ...
      <div className={styles.mid_container}>
        ...
        {buffer ? (
          ...
          <IconBtn onClick={onPlayPause}>
            {playing ? <Pause style={{ fontSize: '48px' }} /> : <PlayArrow style={{ fontSize: '48px' }} />}
          </IconBtn>
        )}
        ...
        <div className={styles.control_box}>
          ...
          <div className={styles.side_controls}>
            ...
            <IconBtn onClick={() => {
              ...
              const container = playerRef.current?.wrapper?.parentElement || playerRef.current?.parentElement;
